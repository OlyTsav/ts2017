...
<div class="container project-container">
	<h2 class="results-title">Displaying results for: <font style="color:#383838;"><?php the_search_query(); ?></font></h2>
	<div class="row">
...
<?php endif; ?>
<p style="text-align: center; color:#ccc; padding:50px 0px; text-decoration:underline">No more results for: <?php the_search_query(); ?></p>
	</div>
  	</div><!--row-->
