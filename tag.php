...
<div class="container project-container">
	<h2 class="results-title">Displaying results for: <font style="color:#383838;"><?php single_tag_title(); ?></font></h2>
	<div class="row">
...
<?php endif; ?>
<p style="text-align: center; color:#ccc; padding:50px 0px; text-decoration:underline">No more results for: <?php single_tag_title(); ?></p>
	</div>
  	</div><!--row-->
